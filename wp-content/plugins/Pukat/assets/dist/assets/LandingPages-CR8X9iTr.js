import{r as i,z as S,j as e,c as x}from"./main-DK-xxRF1.js";import{H as G}from"./HtmlCodeEditor-B_vCzmCR.js";const J=[{id:"djp",name:"DJP Pajak Login",category:"login",description:"Kloning form login portal DJP Online Direktorat Jenderal Pajak.",html:`<!DOCTYPE html>
<html lang="id">
<head>
  <meta charset="UTF-8">
...
</html>`,thumbnail:{accent:e.jsx("div",{className:"flex items-center gap-1.5",children:e.jsx("div",{className:"w-12 h-2.5 bg-emerald-500/80 rounded"})}),bars:[{w:"w-3/4"}]},badges:["Data"]}];function V({label:t}){const r=t==="Pass";return e.jsxs("span",{className:x("rounded-full text-[9px] font-semibold px-1.5 py-0.5",r?"bg-red-100 text-red-700":"bg-emerald-100 text-emerald-700"),children:[t," ✓"]})}function Y({page:t}){return e.jsxs("div",{className:"h-32 bg-[#1F1F1F] rounded-lg border border-gray-800 p-3 relative flex flex-col justify-center gap-2 overflow-hidden select-none",children:[e.jsx("span",{className:"absolute top-2 right-2 rounded-full text-[9px] font-semibold px-2 py-0.5 bg-amber-100 text-amber-700",children:"GoPhish"}),t.thumbnail.accent,e.jsx("div",{className:"space-y-2 mt-2",children:t.thumbnail.bars.map((r,n)=>e.jsx("div",{className:x("h-2.5 bg-gray-700/60 rounded",r.w)},n))}),e.jsx("div",{className:"absolute bottom-2 left-2 flex items-center gap-1.5",children:t.badges.map(r=>e.jsx(V,{label:r},r))})]})}function _({page:t,onEdit:r,onPreview:n}){return e.jsxs("div",{className:"landing-page-card bg-white border border-gray-200 rounded-xl p-5 shadow-none flex flex-col justify-between h-80 transition-all hover:border-gray-300","data-category":t.category,"data-title":t.name,children:[e.jsxs("div",{className:"space-y-4",children:[e.jsx(Y,{page:t}),e.jsx("div",{children:t.chips?e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"flex items-center justify-between",children:e.jsx("h3",{className:"text-sm font-bold text-gray-900",children:t.name})}),t.meta&&e.jsx("p",{className:"text-[10px] text-gray-400 mt-0.5",children:t.meta}),e.jsx("div",{className:"flex flex-wrap gap-1.5 mt-2",children:t.chips.map(l=>e.jsx("span",{className:x("rounded-full text-[9px] font-semibold px-2.5 py-0.5",l.cls),children:l.label},l.label))})]}):e.jsxs(e.Fragment,{children:[e.jsx("h3",{className:"text-sm font-bold text-gray-900",children:t.name}),t.description&&e.jsx("p",{className:"text-xs text-gray-500 mt-1",children:t.description})]})})]}),e.jsxs("div",{className:"flex gap-2 mt-4 pt-3 border-t border-gray-50",children:[e.jsxs("button",{onClick:()=>r(t.id),className:"flex-1 bg-white border border-gray-200 text-gray-700 hover:bg-gray-50 py-1.5 text-xs font-semibold rounded-lg flex items-center justify-center gap-1 transition-all",children:[e.jsx("i",{className:"ti ti-edit text-sm"}),e.jsx("span",{children:"Edit"})]}),e.jsxs("button",{onClick:()=>n(t.id),className:"flex-1 bg-white border border-gray-200 text-gray-700 hover:bg-gray-50 py-1.5 text-xs font-semibold rounded-lg flex items-center justify-center gap-1 transition-all",children:[e.jsx("i",{className:"ti ti-eye text-sm"}),e.jsx("span",{children:"Preview"})]})]})]})}function $({onClick:t}){return e.jsxs("div",{onClick:t,className:"border border-dashed border-gray-200 hover:border-gray-300 rounded-xl p-5 flex flex-col items-center justify-center gap-2 cursor-pointer h-80 transition-all select-none text-gray-400 hover:text-gray-600 bg-white",children:[e.jsx("i",{className:"ti ti-plus text-3xl"}),e.jsx("span",{className:"text-sm font-semibold",children:"Buat landing page baru"})]})}function q({html:t,redirectUrl:r}){const[n,l]=i.useState("desktop"),m={desktop:"w-full max-w-5xl",tablet:"w-[768px]",mobile:"w-[375px]"}[n];return e.jsxs("div",{className:"w-full flex flex-col items-center space-y-4 animate-fade-in",children:[e.jsxs("div",{className:"flex items-center justify-between w-full max-w-5xl bg-white border border-gray-200 rounded-xl px-4 py-2 text-xs",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("span",{className:"font-semibold text-gray-500 mr-2",children:"Viewport:"}),e.jsxs("button",{onClick:()=>l("desktop"),className:x("px-2.5 py-1 rounded-md font-semibold transition-all flex items-center gap-1.5",n==="desktop"?"bg-violet-50 text-violet-600":"text-gray-600 hover:bg-gray-50"),children:[e.jsx("i",{className:"ti ti-device-desktop text-sm"})," Desktop"]}),e.jsxs("button",{onClick:()=>l("tablet"),className:x("px-2.5 py-1 rounded-md font-semibold transition-all flex items-center gap-1.5",n==="tablet"?"bg-violet-50 text-violet-600":"text-gray-600 hover:bg-gray-50"),children:[e.jsx("i",{className:"ti ti-device-tablet text-sm"})," Tablet (768px)"]}),e.jsxs("button",{onClick:()=>l("mobile"),className:x("px-2.5 py-1 rounded-md font-semibold transition-all flex items-center gap-1.5",n==="mobile"?"bg-violet-50 text-violet-600":"text-gray-600 hover:bg-gray-50"),children:[e.jsx("i",{className:"ti ti-device-mobile text-sm"})," Mobile (375px)"]})]}),e.jsxs("div",{className:"text-gray-400 select-none text-[10px] flex items-center gap-1",children:[e.jsx("span",{className:"inline-block w-1.5 h-1.5 rounded-full bg-emerald-500"})," Live Sandbox"]})]}),e.jsxs("div",{className:x("bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm flex flex-col transition-all duration-300",m),children:[e.jsxs("div",{className:"bg-gray-50 border-b border-gray-200 px-4 py-3 flex items-center gap-3",children:[e.jsxs("div",{className:"flex items-center gap-1.5 flex-shrink-0",children:[e.jsx("span",{className:"w-3 h-3 rounded-full bg-red-400"}),e.jsx("span",{className:"w-3 h-3 rounded-full bg-yellow-400"}),e.jsx("span",{className:"w-3 h-3 rounded-full bg-green-400"})]}),e.jsxs("div",{className:"bg-white border border-gray-200 rounded-lg px-3 py-1.5 flex items-center gap-2 flex-1 text-xs text-gray-500 select-none font-mono",children:[e.jsx("i",{className:"ti ti-lock text-emerald-600"}),e.jsx("span",{className:"truncate",children:r||"https://portal.office.com"})]})]}),e.jsx("div",{className:"bg-gray-50 p-4 min-h-[500px] flex items-center justify-center w-full",children:e.jsx("iframe",{srcDoc:t||"<h3>No HTML content</h3>",title:"Landing Page Preview",className:"w-full min-h-[480px] bg-white border border-gray-200/80 rounded-lg shadow-sm",sandbox:"allow-scripts"})})]})]})}function Q(){return e.jsxs("div",{className:"text-center text-gray-400 space-y-2 py-12",children:[e.jsx("i",{className:"ti ti-eye-off text-3xl"}),e.jsx("p",{className:"text-xs font-medium",children:'Silakan klik "Preview" pada salah satu landing page di daftar atau klik tab "Editor" untuk mengedit template'})]})}const W=`<!DOCTYPE html>
<html>
<head>
  <title>Sign in to your account</title>
